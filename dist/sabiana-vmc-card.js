 ...
 */
const Z = globalThis, ae = Z.ShadowRoot && (Z.ShadyCSS === void 0 || Z.ShadyCSS.nativeShadow) && "adoptedStyleSheets" in Document.prototype && "replace" in CSSStyleSheet.prototype, ie = Symbol(), Ae = /* @__PURE__ */ new WeakMap();
let Re = class {
  constructor(e, t, a) {
  ...
  get styleSheet() {
    ...
    if (ae && e === void 0) {
      ...
      a && (e = Ae.get(t)), e === void 0 && ((this.o = e = new CSSStyleSheet()).replaceSync(this.cssText), a && Ae.set(t, e));
    }
    return e;
  }
  toString() {
...
const Ze = (r) => new Re(typeof r == "string" ? r : r + "", void 0, ie), je = (r, ...e) => {
...
}, Se = ae ? (r) => r : (r) => r instanceof CSSStyleSheet ? ((e) => {
  let t = "";
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const { is: Ye, defineProperty: Qe, getOwnPropertyDescriptor: Xe, getOwnPropertyNames: et, getOwnPropertySymbols: tt, getPrototypeOf: rt } = Object, k = globalThis, ke = k.trustedTypes, at = ke ? ke.emptyScript : "", X = k.reactiveElementPolyfillSupport, L = (r, e) => r, J = { toAttribute(r, e) {
  switch (e) {
    case Boolean:
      r = r ? at : null;
      break;
  ...
  return t;
} }, se = (r, e) => !Ye(r, e), Ee = { attribute: !0, type: String, converter: J, reflect: !1, useDefault: !1, hasChanged: se };
...
let H = class extends HTMLElement {
  ...
  static getPropertyDescriptor(e, t, a) {
    const { get: i, set: s } = Xe(this.prototype, e) ?? { get() {
      return this[t];
    }, set(o) {
      this[t] = o;
    } };
  ...
  static finalize() {
    ...
    if (this.finalized = !0, this._$Ei(), this.hasOwnProperty(L("properties"))) {
      const t = this.properties, a = [...et(t), ...tt(t)];
  ...
  static finalizeStyles(e) {
    ...
    if (Array.isArray(e)) {
      ...
      for (const i of a) t.unshift(Se(i));
...
H.elementStyles = [], H.shadowRootOptions = { mode: "open" }, H[L("elementProperties")] = /* @__PURE__ */ new Map(), H[L("finalized")] = /* @__PURE__ */ new Map(), X == null || X({ ReactiveElement: H }), (k.reactiveElementVersions ?? (k.reactiveElementVersions = [])).push("2.1.1");
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */
const I = globalThis, Y = I.trustedTypes, Ce = Y ? Y.createPolicy("lit-html", { createHTML: (r) => r }) : void 0, Be = "$lit$", S = `lit$${Math.random().toFixed(9).slice(2)}$`, De = "?" + S, it = `<${De}>`, z = document, V = () => z.createComment(""), G = (r) => r === null || typeof r != "object" && typeof r != "function", oe = Array.isArray, st = (r) => oe(r) || typeof (r == null ? void 0 : r[Symbol.iterator]) == "function", ee = `[ 	
\f\r]`, D = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, Pe = /-->/g, Me = />/g, P = RegExp(`>|${ee}(?:([^\\s"'>=/]+)(${ee}*=${ee}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g"), Te = /'/g, ze = /"/g, Le = /^(?:script|style|textarea|title)$/i, ot = (r) => (e, ...t) => ({ _$litType$: r, strings: e, values: t }), w = ot(1), F = Symbol.for("lit-noChange"), m = Symbol.for("lit-nothing"), Oe = /* @__PURE__ */ new WeakMap(), M = z.createTreeWalker(z, 129);
function Ie(r, e) {
...
const nt = (r, e) => {
  ...
  for (let l = 0; l < t; l++) {
    const n = r[l];
    let u, _, p = -1, g = 0;
    for (; g < n.length && (o.lastIndex = g, _ = o.exec(n), _ !== null); ) g = o.lastIndex, o === D ? _[1] === "!--" ? o = Pe : _[1] !== void 0 ? o = Me : _[2] !== void 0 ? (Le.test(_[2]) && (i = RegExp("</" + _[2], "g")), o = P) : _[3] !== void 0 && (o = P) : o === P ? _[0] === ">" ? (o = i ?? D, p = -1) : _[1] === void 0 ? p = -2 : (p = o.lastIndex - _[2].length, u = _[1], o = _[3] === void 0 ? P : _[3] === '"' ? ze : Te) : o === ze || o === Te ? o = P : o === Pe || o === Me ? o = D : (o = P, i = void 0);
    const v = o === P && r[l + 1].startsWith("/>") ? " " : "";
    s += o === D ? n + it : p >= 0 ? (a.push(u), n.slice(0, p) + Be + n.slice(p) + S + v) : n + S + (p === -2 ? l : v);
  }
  return [Ie(r, s + (r[t] || "<?>") + (e === 2 ? "</svg>" : e === 3 ? "</math>" : "")), a];
};
class q {
  constructor({ strings: e, _$litType$: t }, a) {
    ...
    this.parts = [];
    let s = 0, o = 0;
    const l = e.length - 1, n = this.parts, [u, _] = nt(e, t);
    if (this.el = q.createElement(u, a), M.currentNode = this.el.content, t === 2 || t === 3) {
    ...
    for (; (i = M.nextNode()) !== null && n.length < l; ) {
      if (i.nodeType === 1) {
        if (i.hasAttributes()) for (const p of i.getAttributeNames()) if (p.endsWith(Be)) {
          const g = _[o++], v = i.getAttribute(p).split(S), A = /([.?@])?(.*)/.exec(g);
          n.push({ type: 1, index: s, name: A[2], strings: v, ctor: A[1] === "." ? ct : A[1] === "?" ? dt : A[1] === "@" ? pt : Q }), i.removeAttribute(p);
        } else p.startsWith(S) && (n.push({ type: 6, index: s }), i.removeAttribute(p));
        if (Le.test(i.tagName)) {
          const p = i.textContent.split(S), g = p.length - 1;
          if (g > 0) {
            i.textContent = Y ? Y.emptyScript : "";
            for (let v = 0; v < g; v++) i.append(p[v], V()), M.nextNode(), n.push({ type: 2, index: ++s });
            i.append(p[g], V());
          }
        }
      } else if (i.nodeType === 8) if (i.data === De) n.push({ type: 2, index: s });
      else {
        let p = -1;
        for (; (p = i.data.indexOf(S, p + 1)) !== -1; ) n.push({ type: 7, index: s }), p += S.length - 1;
      }
      s++;
    }
  }
...
function R(r, e, t = r, a) {
  var o, l;
  if (e === F) return e;
  let i = a !== void 0 ? (o = t._$Co) == null ? void 0 : o[a] : t._$Cl;
  const s = G(e) ? void 0 : e._$litDirective$;
  return (i == null ? void 0 : i.constructor) !== s && ((l = i == null ? void 0 : i._$AO) == null || l.call(i, !1), s === void 0 ? i = void 0 : (i = new s(r), i._$AT(r, t, a)), a !== void 0 ? (t._$Co ?? (t._$Co = []))[a] = i : t._$Cl = i), i !== void 0 && (e = R(r, i._$AS(r, e.values), i, a)), e;
}
class lt {
  constructor(e, t) {
  ...
  u(e) {
    ...
    M.currentNode = i;
    let s = M.nextNode(), o = 0, l = 0, n = a[0];
    for (; n !== void 0; ) {
      if (o === n.index) {
        let u;
        n.type === 2 ? u = new W(s, s.nextSibling, this, e) : n.type === 1 ? u = new n.ctor(s, n.name, n.strings, this, e) : n.type === 6 && (u = new ut(s, this, e)), this._$AV.push(u), n = a[++l];
      }
      o !== (n == null ? void 0 : n.index) && (s = M.nextNode(), o++);
    }
    return M.currentNode = z, i;
  }
  p(e) {
    let t = 0;
...
class W {
  ...
  _$AI(e, t = this) {
    e = R(this, e, t), G(e) ? e === m || e == null || e === "" ? (this._$AH !== m && this._$AR(), this._$AH = m) : e !== this._$AH && e !== F && this._(e) : e._$litType$ !== void 0 ? this.$(e) : e.nodeType !== void 0 ? this.T(e) : st(e) ? this.k(e) : this._(e);
  }
  O(e) {
  ...
  _(e) {
    this._$AH !== m && G(this._$AH) ? this._$AA.nextSibling.data = e : this.T(z.createTextNode(e)), this._$AH = e;
  }
  $(e) {
    var s;
    const { values: t, _$litType$: a } = e, i = typeof a == "number" ? this._$AC(e) : (a.el === void 0 && (a.el = q.createElement(Ie(a.h, a.h[0]), this.options)), a);
    if (((s = this._$AH) == null ? void 0 : s._$AD) === i) this._$AH.p(t);
    else {
      const o = new lt(i, this), l = o.u(this.options);
...
class Q {
  ...
  _$AI(e, t = this, a, i) {
    ...
    let o = !1;
    if (s === void 0) e = R(this, e, t, 0), o = !G(e) || e !== this._$AH && e !== F, o && (this._$AH = e);
    else {
      const l = e;
      let n, u;
      for (e = s[0], n = 0; n < s.length - 1; n++) u = R(this, l[a + n], t, n), u === F && (u = this._$AH[n]), o || (o = !G(u) || u !== this._$AH[n]), u === m ? e = m : e !== m && (e += (u ?? "") + s[n + 1]), this._$AH[n] = u;
    }
    o && !i && this.j(e);
  }
  j(e) {
...
var Fe;
U._$litElement$ = !0, U.finalized = !0, (Fe = T.litElementHydrateSupport) == null || Fe.call(T, { LitElement: U });
const re = T.litElementPolyfillSupport;
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const mt = { attribute: !0, type: String, converter: J, reflect: !1, hasChanged: se }, ht = (r = mt, e, t) => {
...
function j(r) {
  return (e, t) => typeof t == "object" ? ht(r, e, t) : ((a, i, s) => {
...
function K(r, e, t = "en", a = 1) {
  const i = b(r, e), s = i !== void 0 ? parseFloat(i) : void 0, o = $t(s, t, a);
  return xt(r, e, o);
}
function N(r, e = 0) {
...
var St = Object.defineProperty, kt = Object.getOwnPropertyDescriptor, B = (r, e, t, a) => {
  for (var i = a > 1 ? void 0 : a ? kt(e, t) : e, s = r.length - 1, o; s >= 0; s--)
    (o = r[s]) && (i = (a ? o(e, t, i) : o(i)) || i);
  return a && i && St(e, t, i), i;
};
...
function Et() {
  var le, ce, de, pe, ue, _e, me, he, fe, be, ge, ve, ye, $e, xe, we;
  ...
  const r = this.hass.language, e = "0.10.23.1761256611866", t = b(this.hass, (le = this.entities) == null ? void 0 : le.model, "n/a"), a = b(this.hass, (ce = this.entities) == null ? void 0 : ce.power, "off") === "on", i = Tt(this.hass, this.entities), s = b(this.hass, (de = this.entities) == null ? void 0 : de.boost, "off") === "on", o = s ? d(r, c.ui.card.sabiana_vmc.messages.boost_on) : d(r, c.ui.card.sabiana_vmc.messages.boost_off), l = b(this.hass, (pe = this.entities) == null ? void 0 : pe.bypass, "off") === "on", n = l ? d(r, c.ui.card.sabiana_vmc.messages.bypass_on) : d(r, c.ui.card.sabiana_vmc.messages.bypass_off), u = b(this.hass, (ue = this.entities) == null ? void 0 : ue.defrost, "off") === "on", _ = u ? d(r, c.ui.card.sabiana_vmc.messages.defrost_on) : d(r, c.ui.card.sabiana_vmc.messages.defrost_off), p = b(this.hass, (_e = this.entities) == null ? void 0 : _e.mode) || "", g = N(b(this.hass, (me = this.entities) == null ? void 0 : me.program)), v = N(b(this.hass, (he = this.entities) == null ? void 0 : he.fan_speed)), A = Ct(N(b(this.hass, (fe = this.entities) == null ? void 0 : fe.duty_cycle_fan_1))), Ge = a && A > 0 ? "fan-anim" : "", qe = N(b(this.hass, (be = this.entities) == null ? void 0 : be.holiday_mode_days), 1), We = N(b(this.hass, (ge = this.entities) == null ? void 0 : ge.temp_for_free_cooling), 26), Ke = N(b(this.hass, (ve = this.entities) == null ? void 0 : ve.temp_for_free_heating), 20);
  return w`
<ha-card>
  ...
  <div class="main-row">
    ...
    <div class="temps">
      <div>
        <div>${K(this.hass, (ye = this.entities) == null ? void 0 : ye.temp_in)}</div>
        <div class="label">${d(r, c.ui.card.sabiana_vmc.temperature.internal)}</div>
      </div>
      <div>
        <div>${K(this.hass, ($e = this.entities) == null ? void 0 : $e.temp_out)}</div>
        <div class="label">${d(r, c.ui.card.sabiana_vmc.temperature.external)}</div>
      </div>
      <div>
        <div>${K(this.hass, (xe = this.entities) == null ? void 0 : xe.temp_exhaust)}</div>
        <div class="label">${d(r, c.ui.card.sabiana_vmc.temperature.exhaust)}</div>
      </div>
      <div>
        <div>${K(this.hass, (we = this.entities) == null ? void 0 : we.temp_disposal)}</div>
    ...
    <div
      ...
      <svg xmlns="http://www.w3.org/2000/svg" 
        class="${Ge}"
        fill="currentColor"
        style="${A > 0 ? `animation-duration: ${Pt(A)};` : ""}"
        viewBox="0 0 24 24"
...
function Ot(r) {
  const e = Object.entries(zt).map(([t, a]) => [
    t,
    a.replace("@prefix@", r)
  ]);
  return Object.fromEntries(e);
}
var Nt = Object.defineProperty, Ht = Object.getOwnPropertyDescriptor, C = (r, e, t, a) => {
  for (var i = a > 1 ? void 0 : a ? Ht(e, t) : e, s = r.length - 1, o; s >= 0; s--)
    (o = r[s]) && (i = (a ? o(e, t, i) : o(i)) || i);
  return a && i && Nt(e, t, i), i;
};
let x = class extends U {
  constructor() {
    super(...arguments), this.modalMessage = "", this.spinner = !1, this.modalTemp4Bypass = !1, this.render = Et;
  }
  setConfig(r) {
    var e;
  ...
  updated(r) {
    ...
    if (super.updated(r), r.has("config")) {
      if (!this.hass || !((e = this.config) != null && e.entity_prefix))
        return;
      this.entities = Ot(this.config.entity_prefix);
