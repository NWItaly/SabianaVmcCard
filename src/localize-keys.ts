...
export const LOC_KEYS = {
  "ui": {
    "card": {
      "sabiana_vmc": {
        "title": "ui.card.sabiana_vmc.title",
        "temperature": {
        ...
        "actions": {
          "power": "ui.card.sabiana_vmc.actions.power",
          "power_on": "ui.card.sabiana_vmc.actions.power_on",
          "power_off": "ui.card.sabiana_vmc.actions.power_off",
          "mode": "ui.card.sabiana_vmc.actions.mode",
          "program": "ui.card.sabiana_vmc.actions.program",
          "fan_speed": "ui.card.sabiana_vmc.actions.fan_speed"
        },
        "modes": {
        ...
        "version": "ui.card.sabiana_vmc.version"
      }
    }
  }
} as const;
